...
<head>
  ...
  <title>SMP Xaverius 1 Bandar Lampung | Kategori Berita</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url().'admin/files'?>">
            <i class="fa fa-star-o"></i> <span>Prestasi Siswa</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y');?> SMP Xaverius 1 Bandar Lampung</strong> All rights reserved.
  </footer>
