...
<head>
  ...
  <title>Gallery - SMP Xaverius 1 Bandar Lampung</title>
...
<div class="row">
  <div class="col-md">
    <h3 class="mb-4">A. Class Meeting Siswa</h3>
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="<?php echo base_url().'theme/images/cm-1.jpg'?>" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo base_url().'theme/images/cm-2.jpg'?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo base_url().'theme/images/cm-3.jpg'?>" alt="Third slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo base_url().'theme/images/cm-4.jpg'?>" alt="Fourth slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo base_url().'theme/images/cm-5.jpg'?>" alt="Fifth slide">
                </div>
            </div>
    ...
    <div class="col-md">
        <h3 class="mt-5 mb-4">B. Upacara</h3>
            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/up-1.jpg'?>" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/up-2.jpg'?>" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/up-3.jpg'?>" alt="Third slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/up-4.jpg'?>" alt="Fourth slide">
                    </div>
                </div>
    ...
    <div class="col-md">
        <h3 class="mt-5 mb-4">C. Lingkungan Sekolah</h3>
            <div id="carouselExampleControls3" class="carousel slide mb-5" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-1.jpg'?>" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-2.jpg'?>" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-3.jpg'?>" alt="Third slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-4.jpg'?>" alt="Fourth slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-5.jpg'?>" alt="Fourth slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-6.jpg'?>" alt="Fourth slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-7.jpg'?>" alt="Fourth slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url().'theme/images/lk-8.jpg'?>" alt="Fourth slide">
                    </div>
                </div>
